...
int main(int, char**)
{
    ...
    PioStateMachine pio;
    // Load WS2812 program as in your example
            ...
            if (ImGui::BeginTabBar("PioTabs"))
            {
                if (ImGui::BeginTabItem("Controls"))
                {
                    ...
                    if (ImGui::Button("Reset")) {
                        // Reinitialize (simplified; you may need to add a reset method)
                        pio = PioStateMachine();
                        // Reload instructions/settings/data as above
                        for (size_t i = 0; i < sizeof(ws2812_program_instructions) / sizeof(uint16_t); i++)
                            pio.instructionMemory[i] = ws2812_program_instructions[i];
                        pio.settings.sideset_opt = false;
                        pio.settings.sideset_count = 1;
                ...
                if (ImGui::BeginTabItem("Registers"))
                {
                    if (ImGui::BeginTable("RegistersTable", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
                    {
                        ...
                        ImGui::Text("X");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("0x%08x", pio.regs.x);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Y");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("0x%08x", pio.regs.y);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("ISR");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("0x%08x (Shift Count: %u)", pio.regs.isr, pio.regs.isr_shift_count);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("OSR");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("0x%08x (Shift Count: %u)", pio.regs.osr, pio.regs.osr_shift_count);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("PC");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%u", pio.regs.pc);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Delay");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%u", pio.regs.delay);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Status");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%u", pio.regs.status);
                ...
                if (ImGui::BeginTabItem("Settings"))
                {
                    if (ImGui::BeginTable("SettingsTable", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
                    {
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", pio.settings.push_threshold);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Pull Threshold");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", pio.settings.pull_threshold);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", pio.settings.warp_start);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Warp End");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", pio.settings.warp_end);
                ...
                if (ImGui::BeginTabItem("GPIO"))
                {
                    if (ImGui::BeginTable("GPIOTable", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
                    {
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", pio.gpio.raw_data[22]);

                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Pin 22 Pindir");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d (0=output,1=input)", pio.gpio.pindirs[22]);
                ...
                if (ImGui::BeginTabItem("IRQs"))
                {
                    if (ImGui::BeginTable("IRQTable", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
                    {
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%s", pio.irq_is_waiting ? "true" : "false");
                        ...
                        for (int i = 0; i < 8; ++i) {
                            ...
                            ImGui::TableSetColumnIndex(1);
                            ImGui::Text("%s", pio.irq_flags[i] ? "true" : "false");
                        }
