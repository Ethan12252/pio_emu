...
TEST_CASE("SET Register Instructions")
{
    PioStateMachine pio;
    ...
    SUBCASE("Reserved destinations")
    {
        ...
        pio.executeSet();
        CHECK(pio.regs.x == 0); // Should remain unchanged
        CHECK(pio.regs.y == 0); // Should remain unchanged

        // Reserved destinations 0b101, 0b110, 0b111
...
TEST_CASE("SET PINS Instructions")
{
    ...
    SUBCASE("Basic PINS operation")
    {
        ...
        pio.currentInstruction = buildSetInstruction(PioDestination::PINS, 5); // 0b00101
        pio.executeSet();
    ...
    SUBCASE("PINS with custom base")
    {
        ...
        pio.currentInstruction = buildSetInstruction(PioDestination::PINS, 6);
        pio.executeSet();
    ...
    SUBCASE("PINS with high base")
    {
        ...
        pio.currentInstruction = buildSetInstruction(PioDestination::PINS, 21);
        pio.executeSet();
    ...
    SUBCASE("PINS with wrap-around")
    {
        ...
        pio.currentInstruction = buildSetInstruction(PioDestination::PINS, 31);
        pio.executeSet();
    ...
    SUBCASE("PINS with zero count")
    {
        ...
        pio.currentInstruction = buildSetInstruction(PioDestination::PINS, 15);
        pio.executeSet();
